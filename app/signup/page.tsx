      ...
      <div className="relative z-10 max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-white/70 text-lg">
            Join FinAIse to start your AI-powered investment journey
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6 bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-white/80">
              I agree to the{" "}
              <Link href="/terms" className="text-secondary-300 hover:text-secondary-200 transition-colors">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-secondary-300 hover:text-secondary-200 transition-colors">
                Privacy Policy
              </Link>
            </label>
          </div>
